    ...
    <x-slot name="authForm">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <div class="mt-4">
                ...
                <x-input id="password" class="block mt-2 w-full" :focus-color="$primary" type="password" name="password"
            ...
            <div class="mt-4 flex justify-center">
                <x-button class="w-3/5" :primary-color="$primary" :secondary-color="$secondary">
                    {{ __('Sing in') }}
                </x-button>
            </div>
            ...
            <div class="mt-4 flex flex-col items-center justify-center text-md text-gray-500">
                ...
                @if (Route::has('register'))
                    ...
                    <x-link href="{{ route('register') }}" class="text-base font-semibold" :color="$primary"
                        :hover="$secondary">
                        {{ __('Sign up') }}
                    </x-link>
                @endif
